...
<div class="container">
    <div class="row">
        <div class="col-md-8">
            <ol class="breadcrumb">
                <li><a href="#">Home</a></li>
                <li class="active">About Event Vendor</li>
            </ol>
        </div>
    </div>
</div>
        ...
        <div class="col-md-3 side-nav" id="leftCol">
            <div class="hide-side">
                <ul class="listnone nav" id="sidebar">
                    <li class="col-md-12 active"><a href="#aboutus">About us</a></li>
                    <li class="col-md-12"><a href="#team">Meet The Team</a></li>
                    <li class="col-md-12"><a href="#howwork">How it works</a></li>
                    <li class="col-md-12"><a href="#history">Our History</a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="aboutus" id="aboutus">
                        ...
                        <p>We will support you and advise you. We are never short of suggestions or inspiring ideas.Our matchless, which makes finding beautiful wedding venue easier and one less thing for you to worry about.With our inspir blog, suggestions and sensational offers, no one understands Event better than we do.</p>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="call-to-action well-box mt30">
                        <h1>Online Event Planning </h1>
                        <h3 class="point">Advice &amp; Guide. | Save your date. | Forever free.</h3>
                        <img src="images/cycle-graphic.png" alt="" class="graphic img-responsive"> <a href="{{url('/')}}" class="btn btn-default btn-lg">Get start today</a> </div>
                </div>
                <div class="col-md-12 team-section" id="team">
                    ...
                    <div class="row team-section">
                        <div class="col-md-3 text-center team-block">
                            <div class="team-pic">
                                <!-- team pic -->
                                <a href="#"><img src="images/team-pic1.jpg" class="img-responsive" alt=""></a>
                            </div>
                            <!-- /.team pic -->
                        ...
                        <div class="col-md-3 text-center team-block">
                            <div class="team-pic">
                                <!-- team pic -->
                                <a href="#"><img src="images/team-pic7.jpg" class="img-responsive" alt=""></a>
                            </div>
                            <!-- /.team pic -->
                        ...
                        <div class="col-md-3 text-center team-block">
                            <div class="team-pic">
                                <!-- team pic -->
                                <a href="#"><img src="images/team-pic8.jpg" class="img-responsive" alt=""></a>
                            </div>
                            <!-- /.team pic -->
                        ...
                        <div class="col-md-3 text-center team-block">
                            <div class="team-pic">
                                <!-- team pic -->
                                <a href="#"><img src="images/team-pic2.jpg" class="img-responsive" alt=""></a>
                            </div>
                            <!-- /.team pic -->
